...
@section('content')
<form action="{{route('user#profileedit')}}" method="POST" enctype="multipart/form-data" class="w-75 mx-auto" style="margin-top:15%;">
    @csrf
    <div class="row d-flex justify-content-center align-items-center">
        <div class="col-lg-3">
            <img src="{{Auth::user()->profile ? asset('user/img/'. Auth::user()->profile) : asset('admin/img/undraw_profile_2.svg')}}" alt="" id=output class="mb-2 w-100">

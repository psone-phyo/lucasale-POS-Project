                ...
                <div class="row g-4">
                    <div class="col-lg-6">
                        <div class="border rounded">
                            <a href="#">
                                <img src="{{asset('product/'. $details->photo)}}" class="img-fluid rounded w-100" alt="Image">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <h4 class="fw-bold mb-3">{{$details->product_name}}</h4>
                    ...
                    <form  method="POST" action="{{route('addToCart', $details->id)}}">
                        ...
                        <div class="input-group quantity mb-5" style="width: 100px;">
                            ...
                            <input type="text" class="form-control form-control-sm text-center border-0" value="1" name="qty">
                            <div class="input-group-btn">

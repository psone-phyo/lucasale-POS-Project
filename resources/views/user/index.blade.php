...
@section('content')
    ...
    <!-- Fruits Shop Start-->
    <div class="container-fluid fruite py-5" id="productslist">
        <div class="container py-5">
            <div class="tab-class text-center">
                <div class="row g-4">
                    ...
                    <div class="col-lg-8 text-end">
                        <form action="{{route('home')}}#productslist" method="get" class="w-100 d-flex align-items-center">
                            <div class="d-flex justify-content-start me-3 w-100">
                                <input type="search" name="searchKey" id="" placeholder="Search Item..." class="form-control d-block w-100" value="{{request('searchKey')}}">
                            </div>
                            <input type="submit" value="Search" class="btn btn-outline-success">
                        </form>
                        <ul class="nav nav-pills d-inline-flex text-center">
                            <li class="nav-item">
                                <a class="d-flex m-2 py-2 bg-light rounded-pill @if ($category_id == 0)
                                    active
                                @endif" href="{{route('home')}}#productslist">
                                    <span class="text-dark" style="width: 130px;">All Products</span>
                                </a>
                            </li>
                            @foreach ($category as $item)
                            <li class="nav-item">
                                <a class="d-flex py-2 m-2 bg-light rounded-pill @if ($item->category_id == $category_id)
                                    active
                                @endif" href="{{route('home', $item->category_id)}}#productslist">

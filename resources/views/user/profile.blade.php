...
<div class="row d-flex justify-content-center align-items-center" style="margin-top:15%">
    <div class="row d-flex justify-content-center align-items-center w-75">
        <div class="col-md-3 offset-md-1">
            <img src="{{Auth::user()->profile != null ? asset('user/img/'. Auth::user()->profile) : asset('admin/img/undraw_profile_2.svg')}}" alt="" class="w-100 rounded-circle" width="150px" height="150px">
        </div>
        <div class="col-md-7 offset-1">
            ...
            <div class=" ">
                <a class=" btn btn-outline-dark mb-1" href="{{route('user#updatepassword')}}">
        ...
        <div class="w-75 mt-3">
            <a href="{{route('user#profileedit')}}" class="btn btn-outline-primary mb-1 w-100">Edit</a>
        </div>
    </div>
</div>
@endsection
